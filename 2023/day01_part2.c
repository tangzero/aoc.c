...
{
    var numbers = new (Array, String, $S("one"), $S("two"), $S("three"), $S("four"), $S("five"), $S("six"), $S("seven"),
                       $S("eight"), $S("nine"));
...
{
    var numbers = new (Array, String, $S("eno"), $S("owt"), $S("eerht"), $S("ruof"), $S("evif"), $S("xis"), $S("neves"),
                       $S("thgie"), $S("enin"));
